    ...
    <div class="container">
      ...
      <div class="navbar-menu" :class="{'is-active': menuActive}" id="navMenu">
        ...
        <div class="navbar-end">
          <nuxt-link to="/auth/login/" v-if="!user" class="navbar-item">Войти</nuxt-link>
          <div v-else class="navbar-item has-dropdown is-hoverable">
            <div class="navbar-link">
              {{ user.username }}
            </div>
            <div class="navbar-dropdown">
              <nuxt-link to="/service/add-games/" class="navbar-item">Добавить игры</nuxt-link>
              <nuxt-link to="/auth/logout/" class="navbar-item">Выход</nuxt-link>
            </div>
          </div>
        </div>
      </div>
